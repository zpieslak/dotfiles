...
set_highlight("CursorLine", { bg = colors.base03 })
...
set_highlight("markdownError", { fg = colors.base1 })
set_highlight("Normal", { fg = colors.base0, bg = colors.base03 })
set_highlight("NormalFloat", { fg = colors.base0, bg = colors.base03 })
...
set_highlight("StatusLineNC", { fg = colors.base2, bg = colors.base02 })
